...
/*
unsigned char plaintext[32] = { 0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07, 0x34,0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07, 0x34 };
...
int main() {                //AES_ECB_MMT
	...
	err = fopen_s(&req, "AES128(ECB)MMT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(ECB)MMT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {                   //CBC MMT
	...
	err = fopen_s(&req, "AES128(CBC)MMT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(CBC)MMT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {       //CTR_KAT
	...
	err = fopen_s(&req, "AES128(CTR)KAT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(CTR)KAT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {
	...
	err = fopen_s(&req, "AES128(ECB)KAT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(ECB)KAT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {        //AES CBC KAT
	...
	err = fopen_s(&req, "AES128(CBC)KAT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(CBC)KAT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {             //ECB MCT
	...
	err = fopen_s(&req, "AES128(ECB)MCT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(ECB)MCT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
...
int main() {             //CTR MCT
	...
	err = fopen_s(&req, "AES128(CTR)MCT.REQ", "rb");
	err1 = fopen_s(&rsp, "AES128(CTR)MCT.RSP", "w");
	if (err == 0) {
		puts("파일 오픈 성공!");
	}
	else {
